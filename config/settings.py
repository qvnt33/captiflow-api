...
SECRET_KEY = 'django-insecure-7x$nd70f0rh-$0wrs07u23iu#53*qz0m((24kl_jwnwe+rkn-b'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Час життя токену
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),  # Час життя refresh токену
}
